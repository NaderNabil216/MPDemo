...
/**
 * Created by NaderNabil on 4/7/2017.
 */
...
public class player_service extends Service implements MVP_Main.service_stuff {
    ...
    private ArrayList<music_file_object> audioList;

    private int audioIndex = -1;
    private music_file_object activeAudio; //an object of the currently playing audio
    //Used to pause/resume MediaPlayer
    private int resumePosition;

    //MediaSession to get data from lock screen
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        switch (what) {
            ...
            case MediaPlayer.MEDIA_ERROR_UNKNOWN:
                ...
                break;
            default:
                Log.d("MediaPlayer Error", "MEDIA ERROR " + extra);
        }
        return false;
    }
    ...
    public void initMediaPlayer() {
        ...
        try {
            ...
            mediaPlayer.setDataSource(activeAudio.getStream_url());
        } catch (IOException e) {
            e.printStackTrace();
            stopSelf();
        }
    ...
    private BroadcastReceiver playNewAudio = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            audioIndex = new StorageUtil(player_service.this).loadAudioIndex();
            if (audioIndex != -1 && audioIndex < audioList.size()) {
                //index is in a valid range
                activeAudio = audioList.get(audioIndex);
            } else {
    ...
    public void register_playNewAudio() {
        ...
        IntentFilter filter = new IntentFilter(Constants.playNewIntent);
    ...
    @Override
    public void register_playPreviousAudio() {
        IntentFilter filter = new IntentFilter(Constants.playPreviousIntent);
    ...
    @Override
    public void register_pause() {
        IntentFilter filter = new IntentFilter(Constants.pauseIntent);
    ...
    @Override
    public void register_resume() {
        IntentFilter filter = new IntentFilter(Constants.ResumeIntent);
    ...
    @Override
    public void register_request_current_position() {
        IntentFilter filter = new IntentFilter(Constants.RequestCurrentPositionIntent);
        registerReceiver(requestCurrentPosition, filter);
    }

    @Override
    public void register_request_resume_position() {
        IntentFilter filter = new IntentFilter(Constants.RequestResumePositionIntent);
        registerReceiver(requestResumePosition, filter);
    }
    ...
    public void updateMetaData() {
        ...
        mediaSession.setMetadata(new MediaMetadataCompat.Builder()
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_TITLE, activeAudio.getAudio_name())
                .build());
    }
    ...
    public void skipToNext() {
        ...
        new StorageUtil(this).storeAudioIndex(audioIndex);
        stopMedia();
        //reset mediaPlayer
        mediaPlayer.reset();
        presenter.play_next();
    ...
    @Override
    public void buildNotification(Status status) {
        ...
        NotificationCompat.Builder notificationBuilder = (NotificationCompat.Builder) new NotificationCompat.Builder(this)
                ...
                .setContentTitle(activeAudio.getAudio_name())
    ...
    public PendingIntent playbackAction(int actionNumber) {
        Intent playbackAction = new Intent(this, player_service.class);
        switch (actionNumber) {
            case 0:
                // Play
